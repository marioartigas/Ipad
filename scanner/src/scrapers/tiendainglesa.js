...
async function searchPrice(productName) {
  ...
  // Tienda Inglesa usa VTEX también
  const apiUrl = `https://tiendainglesa.vtexcommercestable.com.br/api/io/_v/api/intelligent-search/product_search?query=${query}&count=3&locale=es-UY`;
  ...
  try {
    ...
    // Fallback: scraping HTML de búsqueda
  }
  ...
  // Selectores comunes en VTEX legacy
